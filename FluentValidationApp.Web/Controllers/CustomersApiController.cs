    ...
    public class CustomersApiController : ControllerBase
    {
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
            ...
            if (!result.IsValid)
            {
                ...
                return BadRequest(result.Errors.Select(x => new { property=x.PropertyName, error=x.ErrorMessage}));//hangi property üzerinde hata olduğunu ve ne hatası olduğunu dönecektir.
